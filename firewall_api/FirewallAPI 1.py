...
# Type variable for return function annotation
T = TypeVar("T")
...
class Firewall:
    ...
    def _format_xml_response(self, response: Dict[str, Any], entity: str) -> Dict[str, Any]:
        """
        ...
        if "Status" in response:
            logger.debug(f"Status response: {response['Status']}")
    ...
    def _perform_action(self, xml_action: str, entity: str) -> Dict[str, Any]:
        """
        ...
        try:
            logger.debug(f"Sending request for entity: {entity}")
    ...
    @requires_active_session
    def create(self, entity: str, entity_data: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    @requires_active_session
    def update(self, entity: str, entity_data: Dict[str, Any], entity_name: Optional[str] = None, entity_name_key: str = "Name") -> Dict[str, Any]:
        """
    ...
    @requires_active_session
    def delete(self, entity: str, filter_value: str, filter_criteria: str = EQ, filter_key_field: Optional[str] = None) -> Dict[str, Any]:
        """
    ...
    def batch_operation(self, operations: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
        """
